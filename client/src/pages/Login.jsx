        ...
        <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center p-6 relative overflow-hidden">
            ...
            <div className="z-10 w-full max-w-6xl">
                <div className="text-center">
                    <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-green-600 mb-4 pt-5 tracking-tight drop-shadow-sm filter">
